<div align="center">
  ...
  <h1>AlphaStriker – Guide d'Installation Autonome (x86_64 / VPS Standard)</h1>
  <b>Bot de trading ultra-robuste pour l'architecture x86_64 (VPS standards), combinant FastAPI, React, et l'IA Gemini.</b>
</div>
...
Ce guide est destiné aux serveurs avec une architecture **x86_64 / amd64**, comme ceux proposés par Hetzner, OVH, ou les instances standards d'Oracle Cloud (VM.Standard.E2.1.Micro, etc.).
...
- Détecter l'architecture x86_64.
