...
function Navbar() {
    ...
    const inactiveLinkClass = "text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium";
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4">
                                ...
                                <NavLink to="/settings" className={({ isActive }) => isActive ? activeLinkClass : inactiveLinkClass}>Paramètres</NavLink>
                            </div>
                        </div>
                    </div>
                </div>
